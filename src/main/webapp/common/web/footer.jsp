            ...
            <div class="col-12">
                <div class="brand_container owl-carousel">
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand1.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand2.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand3.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand4.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand5.png'/>" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="<c:url value='/template/web/assets/img/brand/brand1.png'/>" alt=""></a>
                    </div>
                    ...
                    <div class="widgets_container">
                        ...
                        <div class="Latest_Posts_wrapper">
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img
                                            src="<c:url value='/template/web/assets/img/category/post1.jpg'/>"
                                            alt=""></a>
                                </div>
                            ...
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img
                                            src="<c:url value='/template/web/assets/img/category/post2.jpg'/>"
                                            alt=""></a>
                                </div>
                                <div class="Latest_Posts_content">
                            ...
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img
                                            src="<c:url value='/template/web/assets/img/category/post3.jpg'/>"
                                            alt=""></a>
                                </div>
                                <div class="Latest_Posts_content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="footer_payment text-right">
                        <p><img src="<c:url value='/template/web/assets/img/icon/payment.png'/>" alt=""></p>
                    </div>
                </div>
            </div>
        </div>
